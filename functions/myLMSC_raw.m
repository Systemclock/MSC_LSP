function [P,H,Z,S,obj,iter] = myLMSC_raw(X,alpha,beta,epilsion,maxIter,K)
...
%    end
   ...
   obj(iter) = temp_formulation1+temp_formulation2+temp_formulation3;%鎬诲??
   if iter>2
